<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-green-500">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $summary['current']['count'] }} bills</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-yellow-400">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $summary['1-30']['count'] }} bills</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-orange-400">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $summary['31-60']['count'] }} bills</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-orange-600">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $summary['61-90']['count'] }} bills</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 border-l-4 border-red-500">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">{{ $summary['90+']['count'] }} bills</div>
        </div>
    </div>

    {{-- Total Outstanding --}}
    <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg shadow p-4 mb-6 border border-purple-200 dark:border-purple-800">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <div class="text-sm text-gray-600 dark:text-gray-400">Total Bills</div>
