...
## Project
POS Multi Cabang + CRM + Omnichannel Marketplace Indonesia

## Source of Truth
Selalu gunakan file berikut sebagai acuan:
- docs/prd.md
...
- Kerjakan satu task kecil pada satu waktu
- Jangan lompat fase tanpa instruksi
- Jangan menambah fitur di luar PRD
...
- Semua data inti tenant-aware
- Semua data operasional branch-aware
- Inventory mutation harus transactional
- Payment mutation harus transactional
...
Saat mulai:
1. baca docs/prd.md
2. baca docs/implementation-plan.md
3. baca docs/task-checklist.md
4. pilih task prioritas tertinggi yang belum selesai
5. tampilkan rencana singkat
6. implement task
7. update docs/progress-log.md
8. berhenti dan laporkan hasil

---

## Output Wajib Setelah Tiap Batch
- Summary
- Files changed
- What was completed
- Remaining gaps
...
## Coding Rules
- Gunakan UUID untuk business tables
- Gunakan decimal untuk money dan qty
- Gunakan enum atau constants untuk status
- Gunakan policy + permissions
- Gunakan service/action class untuk flow besar
- Jangan menaruh business logic utama di Livewire component

---

## Testing Rules
- Tambahkan test pada flow kritikal
- Jangan hapus test existing
- Jika test gagal, jelaskan penyebabnya
